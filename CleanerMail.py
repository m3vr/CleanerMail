		...
		<tr>
			<td style="padding: 10px 0 30px 0;">
				<table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border: 1px solid #cccccc; border-collapse: collapse;">
					<tr>
						<td align="center" bgcolor="#153643" style="padding: 30px 0 30px 0; color: #153643; font-size: 28px; font-weight: bold; font-family: Arial, sans-serif;">
							<img src="http://www.clubhuyzch.nl/images/logo_white-2x.png" alt="Club Huyzch logo" width="200" style="display: block;" />
						</td>
					</tr>
					<tr>
						<td bgcolor="#ffffff" style="padding: 40px 30px 30px 30px;">
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr>
									<td style="color: #43153b; font-family: Arial, sans-serif;text-align: center; font-size: 30px;">
										<b>Schoonmaakrooster</b>
									</td>
								</tr>
								<tr>
									<td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
										Halloooo Huyzch bewoners, er mag weer lekker geschrobt en geboend worden. Hieronder staan de schoonmakers voor week """+str(date.today().isocalendar()[1])+""".
									</td>
								</tr>
								<tr>
									<td>
